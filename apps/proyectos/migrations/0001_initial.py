    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_aceptacion', models.DateField(blank=True, default=None, null=True)),
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gestion.area')),
                ('cliente', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='proyectos.cliente')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entregable', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='proyectos.entregable')),
            ],
            options={
                'ordering': ['-id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('forma_pago', models.CharField(choices=[('CREDITO', 'Crédito'), ('CONTADO', 'Contado')], default='CRÉDITO', max_length=10)),
                ('monto_total', models.FloatField(default=0)),
                ('cantidad_pagos', models.IntegerField(default=1)),
                ('dias_vencimiento', models.IntegerField(default=0)),
                ('contrato', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='proyectos.contrato')),
            ],
        ),
    ]
